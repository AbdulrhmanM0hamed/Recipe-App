...
class CategoriesViewBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final categories = [
      ...
      Category(
          title: 'Chicken',
          imagePath: "assets/images/categories/Chicken.svg",
          mealCount: 25),
      Category(
          title: 'Goat Meat',
          imagePath: "assets/images/categories/GoatMeat.svg",
          mealCount: 15),
      Category(
          title: 'Fish',
          imagePath: "assets/images/categories/Fish.svg",
          mealCount: 30),
      Category(
          title: 'Vegetarian',
          imagePath: "assets/images/categories/Vegetarian.svg",
          mealCount: 40),
      Category(
          title: 'Pasta',
          imagePath: "assets/images/categories/Pasta.svg",
          mealCount: 18),
      Category(
          title: 'Desserts',
          imagePath: "assets/images/categories/Desserts.svg",
          mealCount: 50),
      Category(
          title: 'Soups',
          imagePath: "assets/images/categories/Soups.svg",
          mealCount: 12),
      Category(
          title: 'Grains',
          imagePath: "assets/images/categories/Grains.svg",
          mealCount: 22),
      Category(
          title: 'Salads',
          imagePath: "assets/images/categories/Salads.svg",
          mealCount: 28),
      Category(
          title: 'Beverages',
          imagePath: "assets/images/categories/Beverages.svg",
          mealCount: 10),
      Category(
          title: 'Seafood',
